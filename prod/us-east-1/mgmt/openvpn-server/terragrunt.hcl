...
inputs = {
  ...
  ami           = "ami-08a46b54be0557a60"

  domain_name          = "vpn.aw-prod.cloud"
  create_route53_entry = true

  request_queue_name    = "openvpn-request-queue"
  revocation_queue_name = "openvpn-revocation-queue"

  backup_bucket_name = "allied-world-prod-openvpn-backup"
  ...
  keypair_name = "prod-openvpn-us-east-1-v1"
