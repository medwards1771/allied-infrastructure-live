...
[infrastructure-modules/lambda/s3-image-processing](https://github.com/alliedworld/infrastructure-modules/tree/master/lambda/s3-image-processing).
...
All the Terraform code for this module is defined in [infrastructure-modules/lambda/s3-image-processing](https://github.com/alliedworld/infrastructure-modules/tree/master/lambda/s3-image-processing).
...
For more info, check out the Readme for this module in [infrastructure-modules/lambda/s3-image-processing](https://github.com/alliedworld/infrastructure-modules/tree/master/lambda/s3-image-processing).
