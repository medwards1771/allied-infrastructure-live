...
inputs = {
  ...
  auto_deploy_permissions = ["cloudwatch:*", "logs:*", "dynamodb:*", "ecr:*", "s3:*", "ecs:*", "iam:GetPolicy", "iam:GetPolicyVersion", "iam:ListEntitiesForPolicy", "route53:*", "autoscaling:*", "elasticloadbalancing:*", "iam:GetRole", "iam:GetRolePolicy", "iam:PassRole"]
  allow_auto_deploy_from_other_account_arns = [
    "arn:aws:iam::296216577101:user/circle-ci-machine-user", # machine user in security account
  ]
}
