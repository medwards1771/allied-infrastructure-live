...
inputs = {
  ...
  https_listener_ports_and_ssl_certs = [
    {
      port    = 443
      tls_arn = "arn:aws:iam::805321607950:server-certificate/services-dev.allied-world.aws"
    },
  ]
  ...
  access_logs_s3_bucket_name            = "allied-world-dev-alb-internal-access-logs"

  create_route53_entry = true
  domain_name          = "services-dev.allied-world.aws"
