...
All the Terraform code for this module is defined in [infrastructure-modules/security/iam-groups](https://github.com/alliedworld/infrastructure-modules/tree/master/security/iam-groups).
...
For more info, check out the Readme for this module in [infrastructure-modules/security/iam-groups](https://github.com/alliedworld/infrastructure-modules/tree/master/security/iam-groups).
