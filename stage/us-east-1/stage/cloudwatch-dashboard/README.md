...
This directory creates a CloudWatch Dashboard. Under the hood, this is implemented using Terraform modules from  
[infrastructure-modules/mgmt/cloudwatch-dashboard](https://github.com/alliedworld/infrastructure-modules/tree/master/mgmt/cloudwatch-dashboard).
...
All the Terraform code for this module is defined in [infrastructure-modules/mgmt/cloudwatch-dashboard](https://github.com/alliedworld/infrastructure-modules/tree/master/mgmt/cloudwatch-dashboard).
...
For more info, check out the Readme for this module in [infrastructure-modules/mgmt/cloudwatch-dashboard](https://github.com/alliedworld/infrastructure-modules/tree/master/mgmt/cloudwatch-dashboard).
