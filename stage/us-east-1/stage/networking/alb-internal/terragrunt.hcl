...
inputs = {
  ...
  https_listener_ports_and_ssl_certs = [
    {
      port    = 443
      tls_arn = "arn:aws:iam::645769240473:server-certificate/services-stage.allied-world.aws"
    },
  ]
  ...
  access_logs_s3_bucket_name            = "allied-world-stage-alb-internal-access-logs"

  create_route53_entry = true
  domain_name          = "services-stage.allied-world.aws"
