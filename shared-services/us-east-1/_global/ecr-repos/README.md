...
This Terraform template creates one or more [EC2 Container Registry (ECR)](http://docs.aws.amazon.com/AmazonECR/latest/userguide/what-is-ecr.html)
Repos, which are where Docker images will be uploaded. Note that ECR is an alternative to [Docker Hub](https://hub.docker.com/).
...
All the Terraform code for this module is defined in [infrastructure-modules/data-stores/ecr-repos](https://github.com/alliedworld/infrastructure-modules/tree/master/data-stores/ecr-repos).
...
For more info, check out the Readme for this module in [infrastructure-modules/data-stores/ecr-repos](https://github.com/alliedworld/infrastructure-modules/tree/master/data-stores/ecr-repos).
