...
inputs = {
  ...
  ami           = "ami-04198b722f25b4be2"

  domain_name          = "vpn.aw-shared-services.cloud"
  create_route53_entry = true

  request_queue_name    = "openvpn-request-queue"
  revocation_queue_name = "openvpn-revocation-queue"

  backup_bucket_name = "allied-world-shared-services-openvpn-backup"
  ...
  keypair_name = "shared-services-openvpn-us-east-1-v1"
